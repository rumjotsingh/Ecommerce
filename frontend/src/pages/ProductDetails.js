...
const ProductDetails = () => {
  ...
  // Product images (backend provides single photo per product)
  const productImages = product._id
  ...
  return (
    <Layout title={`${product?.name} - Product Details`}>
        ...
        <div className="container mx-auto px-3 sm:px-4 lg:px-8">
              ...
              <div className="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div className="flex items-baseline gap-2.5 sm:gap-3 lg:gap-4 flex-wrap">
                  ...
                  {product.originalPrice && (
                    <div className="text-2xl text-primary-400 line-through">
          ...
          {filteredRecentlyViewed.length > 0 && (
            <div className="space-y-6 mb-8">
              ...
              <ProductGrid products={filteredRecentlyViewed.slice(0, 4)} columns={4} />
            </div>
          )}
      ...
      {product._id && (
        <div className="fixed bottom-0 left-0 right-0 lg:hidden z-30 glass border-t border-border p-4 flex items-center gap-3">
