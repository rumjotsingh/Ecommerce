  ...
  return (
    <div className={`w-full ${containerClassName}`}>
      ...
      <div className="relative">
        {icon && (
          <div
            className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 flex items-center justify-center pointer-events-none transition-colors duration-200 ${
        ...
        <input
          ...
          className={`w-full py-3 border rounded-xl focus:ring-2 focus:ring-offset-0 outline-none transition-all duration-200 bg-white ${
            icon ? "pl-14" : "pl-4"
