...
const Button = ({
  ...
  const variants = {
    ...
    outline:
      "border border-border-strong text-primary-500 hover:bg-surface-muted focus:ring-accent-500",
    ghost: "text-primary-500 hover:bg-surface-muted focus:ring-accent-500",
